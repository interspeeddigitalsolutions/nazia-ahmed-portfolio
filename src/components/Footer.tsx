...
const Footer = ({ short = false }: FooterProps) => {
    return (
        <footer id="contact" className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.bottomRow}>
                    <p>©️ 2026 Art by Nazia. All artwork and content are protected by copyright. Unauthorized reproduction, commercial use, AI training, or redistribution is prohibited.</p>
                </div>
            </div>
        </footer>
    );
